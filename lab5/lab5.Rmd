...
# Desenho "purple_wave"
- Carregamos a imagem e transformamos em um data-frame.
```{r}
library(ggplot2)
library(magrittr)
library(tidyr)
...
Regressão.
Fórmula proposta com base na análise: b = r + g + u, onde b, r e g são respectivamente as cores: azul, vermelho e verde da imagem, e u é o termo de erro.
```{r}
...
Regressão.
Fórmula proposta com base na análise descritiva: b = r + g + u, onde b, r e g são respectivamente as cores: azul, vermelho e verde da imagem, e u é o termo de erro.
```{r}
...
#Outros exemplos
- Imagem que seria melhor prevista com o modelo de árvore de decisão.
```{r}
